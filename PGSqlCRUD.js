...
const { Sequelize, DataTypes } = require('sequelize');  // Fix: Added DataTypes import
const app = express();

app.use(express.json());

const dbUrl = 'postgres://webadmin:ARPmhm41984@node66590-jezlol.proen.app.ruk-com.cloud:11505/Books';
